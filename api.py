...
class PetFriends:
    ...
    def add_new_pet_without_photo(self, auth_key: json, name: str, animal_type: str,
                    age: str,) -> json:
        """Метод отправляет (постит) на сервер упрощенные данные о добавляемом питомце без фото и возвращает статус
    ...
    def add_new_pet_no_photo(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
        """Метод написан для теста по отправке на сервер данных о добавляемом питомце без фото"""
